...
public sealed class LocalFileSystemWatcherService : IFileSystemWatcherService, IDisposable
{
    ...
    {
        var fileCreatedSubscription = Observable
        ...
        _subscriptions.Add(fileCreatedSubscription);

        var fileDeletedSubscription = Observable
                                      .FromEventPattern<FileSystemEventHandler, FileSystemEventArgs>(
        ...
        _subscriptions.Add(fileDeletedSubscription);

        var fileRenamedSubscription = Observable
        ...
        _subscriptions.Add(fileRenamedSubscription);
    }

    private void SubscribeToDirectoryEvents()
    {
        var directoryCreatedSubscription = Observable
                                           .FromEventPattern<FileSystemEventHandler, FileSystemEventArgs>(
        ...
        _subscriptions.Add(directoryCreatedSubscription);

        var directoryDeletedSubscription = Observable
                                           .FromEventPattern<FileSystemEventHandler, FileSystemEventArgs>(
        ...
        _subscriptions.Add(directoryDeletedSubscription);

        var directoryRenamedSubscription = Observable
                                           .FromEventPattern<RenamedEventHandler, RenamedEventArgs>(
        ...
        _subscriptions.Add(directoryRenamedSubscription);
    }
